			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tbody>
					...
					<td><?php echo $row->modified;?></td>
						<td><A href="<?php echo JRoute::_('index.php?option=com_jhproject&view=wiki&task=viewRevisions&page='.$row->title.'&id='.$row->id.'&project='.$project);?>"><?php echo JText::_('View Revision');?></a></td>
					</tr>
					<?php
						$r = 1-$r;
					}
